        ...
        <>
          ...
          <div className="new-shop__list row">
            <div className="new-shop__item col-4">
              <Link to={`/products/${dataProduct?.data?.content[0]?.slug}`}>
              ...
              <Link to={`/products/${dataProduct?.data?.content[1]?.slug}`}>
            ...
            <div className="new-shop__item col-4">
              <Link to={`/products/${dataProduct?.data?.content[2]?.slug}`}>
              ...
              <Link to={`/products/${dataProduct?.data?.content[3]?.slug}`}>
              ...
              <Link to={`/products/${dataProduct?.data?.content[4]?.slug}`}>
            ...
            <div className="new-shop__item col-4">
              <Link to={`/products/${dataProduct?.data?.content[5]?.slug}`}>
              ...
              <Link to={`/products/${dataProduct?.data?.content[6]?.slug}`}>
