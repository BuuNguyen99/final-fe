...
function PageProductListSmartPhone({ dataSmartphone, onGetViewHomeProduct }) {
  ...
  function handleChange(value) {
    ...
    onGetViewHomeProduct(data, 'smartphone', params);
  }
  ...
  return (
    <div className="page-product-list">
      <div className="page-product-list__banner">
        <div className="page-product-list">
          <h2 className="page-product-list__title">Popular smartphones</h2>
      ...
      <div className="product-container container">
        ...
        <div className="product-list-item">
          {!dataSmartphone?.isFetching && (
            <div className="row">
              {dataSmartphone?.data?.content &&
                dataSmartphone?.data?.content.map((el, index) => (
        ...
        <div className="product-pagination">
          <PaginationComponent
            ...
            pageCount={dataSmartphone?.data?.totalItems}
            activePage={page}
            limit={12}
          />
        </div>
