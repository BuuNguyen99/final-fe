...
function PageProductListLapTop({ dataLaptop, onGetViewHomeProduct }) {
  ...
  function handleChange(value) {
    ...
    onGetViewHomeProduct(data, 'laptop', params);
  }
  ...
  return (
    <div className="page-product-list">
      <div className="page-product-list__banner">
        <div className="page-product-list">
          <h2 className="page-product-list__title">
            Popular Laptops And Tablets
          </h2>
      ...
      <div className="product-container container">
        ...
        <div className="product-list-item">
          {!dataLaptop?.isFetching && (
            <div className="row">
              {dataLaptop?.data?.content &&
                dataLaptop?.data?.content.map((el, index) => (
        ...
        <div className="product-pagination">
          <PaginationComponent
            ...
            pageCount={dataLaptop?.data?.totalItems}
            activePage={page}
            limit={12}
          />
        </div>
